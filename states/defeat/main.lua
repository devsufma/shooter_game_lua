function load()
	defeat = love.graphics.newImage("Images/Textures/defeat.png")
	...
	buttons = {
		{buttonOff = continueOff, buttonOn = continueOn, x = 450, y = 400, w = 256, h = 45, action = "continue"}
	}
end
...
function love.draw()
	...
	love.graphics.draw(defeat, 250, 50, 0, 0.5, 0.5)
end
