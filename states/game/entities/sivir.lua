...
function ent:load(x,y)
	self:setPos(x, y)
	self.imageRight = love.graphics.newImage("Images/Sprites/sivir-right.png")
	self.imageLeft = love.graphics.newImage("Images/Sprites/sivir-left.png")
	self.w = 33
	self.h = 33
...
function ent:update(dt)
	...
	if deltaTime > self.atkspd then
		local bullet = ents.Create("enemy_bullet", self.x, self.y, "none", "sivir")
		bullet:setDestiny()
		deltaTime = 0
	end
