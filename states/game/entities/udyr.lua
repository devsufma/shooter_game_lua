...
function ent:load(x,y)
	self:setPos(x, y)
	self.imageRight = love.graphics.newImage("Images/Sprites/udyr-right.png")
	self.imageLeft = love.graphics.newImage("Images/Sprites/udyr-left.png")
	self.w = 27.6
	self.h = 34.2
...
function ent:draw()
	...
	love.graphics.rectangle("fill", self.x, self.y-4, self.health/100*30, 4)
end
